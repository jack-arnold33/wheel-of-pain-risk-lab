...
The lab uses a production-representative candidate PWA stack to assess risk.
That choice does not select the main application's architecture, and the lab
remains disposable.
